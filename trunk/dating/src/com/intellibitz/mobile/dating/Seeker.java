        ...
        public void onClick(View v) {
                ...
                if (count == 0) {
                    ...
                    if(getSeekerLocation.equals(""))
                     ...
                     myDatabase.execSQL("CREATE TABLE IF NOT EXISTS Seeker"
                                   +" (seekerAge INT(3), seekerSex VARCHAR, seekerHeight INT(3), " +
                     ...
                     myDatabase.execSQL("INSERT INTO Seeker (seekerAge, seekerSex, seekerHeight, seekerWeight, " +
                                   "seekerLocation) VALUES ("+getSeekerAge+",'"+getSeekerSex+"',"+getSeekerHeight
                                               +","+getSeekerWeight+",'"+getSeekerLocation+"');"); 
                     myDatabase.execSQL("CREATE TABLE IF NOT EXISTS Partner"
                                   +" (partnerAgeRange VARCHAR, partnerSex VARCHAR, partnerHeightRange VARCHAR," +
